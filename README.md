...
* A <a href="https://github.com/aneesha/RAKE">Python implementation of the Rapid Automatic Keyword Extraction (RAKE) algorithm</a> algorithm to perform simple sentiment analysis. Keywords extracted from the bio are matched with a custom dictionary of keywords to obtain a score for the text.
